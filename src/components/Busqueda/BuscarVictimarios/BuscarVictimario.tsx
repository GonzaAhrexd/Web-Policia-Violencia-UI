    ...
    return (
        <>
            <form className="w-full flex flex-col items-center"
                ...
                <InputRegister customSize="flex flex-col w-full xl:w-1/2" campo="ID" nombre="id_victimario" register={register} require={false} error={errors.id_victimario} />
                <InputRegister customSize="flex flex-col w-full xl:w-1/2" campo="Nombre" nombre="nombre_victimario" register={register} require={false} error={errors.nombre} />
                <InputRegister customSize="flex flex-col w-full xl:w-1/2" campo="Apellido" nombre="apellido_victimario" register={register} require={false} error={errors.apellido} />
                <InputRegister customSize="flex flex-col w-full xl:w-1/2" campo="DNI" nombre="dni_victimario" register={register} require={false} error={errors.dni_victima} />
