  ...
  return (
    <div className='w-full lg:w-6/10'>
      <div className='flex flex-col xl:flex-row'>
        <InputDate valor={fecha} campo="Fecha" nombre="fecha" register={register} error={errors.fecha} />
      ...
      <div className='flex flex-col my-2'>
        ...
        {!expediente ?
          ...
          :
          <EditExpediente expediente={expediente} campo="Número de Expediente" comisariaPertenece={comisariaPertenece} nombre="numero_de_expediente" register={register} setValue={setValue} error={errors.expediente} />
        }
      </div>
