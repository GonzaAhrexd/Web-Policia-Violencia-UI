...
function EditExpediente({ expediente, campo, nombre, register, error, placeholder, setValue, comisariaPertenece }: InputExpedienteProps) {
    const handleDate = () => {
    ...
    return (
        <div className={`flex flex-col`}>
            ...
            <div className="grid grid-cols-4">
                <input className={`border open-sans border-gray-300 rounded-md h-10 xl:h-8 2xl:h-10 my-2 xl:my-1 xl:m-2 m-4 pl-2`} defaultValue="130/"
                    {...register("PrefijoExpediente", { required: true })} placeholder={placeholder} />
                
                <input className={`border open-sans border-gray-300 rounded-md h-10 xl:h-8  2xl:h-10 my-2 xl:my-1 xl:m-2 m-4 pl-2`}
                ...
                <input className={`border open-sans border-gray-300 rounded-md h-10 xl:h-8  2xl:h-10 my-2 xl:my-1 xl:m-2 m-4 pl-2`} defaultValue={handleDate()}
