    ...
    const RenderDenuncia = () => {
        return (
            <Text style={styles.longText}>
                ...
                quien interrogado por sus datos personales de identidad <Text style={styles.boldText}>DIJO LLAMARSE:</Text> como consta en el titulo, ser de nacionalidad: {datos.nacionalidad_victima},
                ...
                836-N (Ley de Violencia Familiar). Abierto el acto y cedida que le fuere la palabra y en uso de la misma <Text style={styles.boldText}>DENUNCIA:</Text> {datos.observaciones.trim()}{genero == "Femenino" && " Seguidamente se le hace saber que existe la Línea 137, ubicado en Calle Mitre N° 171 -Resistencia-, donde se brinda asesoramiento legal y asistencia psicológica las 24 horas del dia de manera GRATUITA, y la Línea 102 ubicado en Avenida Sarmiento N° 1675-Resistencia-. "} {genero == "Femenino" && (
