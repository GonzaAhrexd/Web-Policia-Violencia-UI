  ...
  return (
    <div className='w-full lg:w-6/10'>
      ...
      <div className='flex flex-col xl:flex-row my-2'>
        <SelectRegisterSingle valor={datos.estado_civil} campo="Estado Civil" nombre="estado_civil_victima" opciones={estadoCivil} setValue={setValue} error={errors.estado_civil_victima} />
        <SelectRegisterSingle valor={datos.ocupacion} campo="Ocupación" nombre="ocupacion_victima" opciones={ocupaciones} setValue={setValue} error={errors.ocupacion_victima} />
        <SelectRegisterSingle valor={datos.vinculo_con_agresor} campo="Vínculo con el Agresor" nombre="vinculo_con_agresor_victima" opciones={vinculo} setValue={setValue} error={errors.vinculo_con_agresor_victima} />
      </div>
      <div className='flex flex-col xl:flex-row my-2'>
      </div>
